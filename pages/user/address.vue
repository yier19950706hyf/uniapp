		...
		<view class="address-list" v-if="addressList.length > 0">
			<view class="item" v-for="(item, index) in addressList" :key="item.id" @tap="addressAddOrUpdate" :data-address-id="item.id">
				<view class="l">
					...
					<view class="default" v-if="item.defaultaddress==='1'">默认</view>
				</view>
				<view class="c">
					<view class="mobile">{{item.userphone}}</view>
					<view class="address">{{item.provincename+item.cityname+item.areacodename+item.addressdetailed}}</view>
				</view>
				<view class="r">
